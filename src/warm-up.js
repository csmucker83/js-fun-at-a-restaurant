...
var stockCount = 5;
if (stockCount >= 1) {
 console.log("I'm going to eat some Pizza");
} else () {
...
if (isFavorite === true) {
 ...
 console.log("I recently ate Pizza.");
}
...
var vegetables = ['peppers', 'squash', 'corn', 'carrot', 'green bean'];
...
// different fruits.
var fruits = ['apple', 'banana', 'strawberry', 'raspberry', 'pineapple'];
...
console.log(groceryStore.push[location: "Denver, CO"]);
